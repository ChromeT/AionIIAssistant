        ...
        >
          ...
          <Animated.View 
            style={[
              ...
              Platform.OS === 'web' ? {
                animationName: 'floatX',
                animationDuration: '4s',
                animationTimingFunction: 'ease-in-out',
                animationIterationCount: 'infinite'
              } as any : { transform: [{ translateX: bannerFloatX }] }
            ]}
          >
...
const styles = StyleSheet.create({
  ...
  scrollContainer: {
    ...
    alignItems: 'center',
    paddingVertical: Platform.OS === 'web' ? 32 : 0,
  ...
  innerContainer: {
    ...
    backgroundColor: Platform.OS === 'web' ? '#111723' : 'transparent',
    ...
    position: 'relative',
    overflow: 'hidden',
    shadowColor: Platform.OS === 'web' ? '#6366F1' : 'transparent',
